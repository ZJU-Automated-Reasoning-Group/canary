/**
 * @file c2chc.cpp
 * @brief Command-line tool to convert C programs to CHC format
 * 
 * This tool takes a C file as input and converts it to CHC (Constrained Horn Clauses)
...
int main(int argc, char* argv[]) {
    ...
    try {
        std::cout << "Converting C file '" << inputFile << "' to CHC format..." << std::endl;
        cParser::c_to_chc(inputFile, outputFile);
