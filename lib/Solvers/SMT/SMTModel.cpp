/**
 * @file SMTModel.cpp
 * @brief Implementation of the SMTModel class that represents models from satisfiable SMT formulas
 *
 * This file implements the SMTModel class, which provides access to models generated by
 * the SMT solver when a formula is satisfiable. It provides:
 ...
 *
 * SMTModel objects are created by the SMTSolver when a satisfiable result is obtained,
 * allowing users to inspect the satisfying assignment for their constraints.
 */
